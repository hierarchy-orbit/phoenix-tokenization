...
contract PSTokenRegistry is PhoenixIdentityOwnable {
  ...
  PSTServiceRegistry public serviceRegistry;
  ...
  */
    ...
    isContract(_serviceRegistryAddress)
  {
   ...
   /**
  * @notice Get a Phoenix Securities Token contract deployed address
  ...
  */
  ...
  public returns(bool) {
    ...
    if ( names[_tokenName].nameExists ) {
      _token = PSToken(names[_tokenName].tokenAddress);
    ...
    if ( symbols[_tokenSymbol].symbolExists ) {
      _token = PSToken(symbols[_tokenSymbol].tokenAddress);
      if ( _token.isTokenAlive() ) {
  ...
  */
  ...
  /**
  * @notice Get a Phoenix Securities Token symbol
  * @param  _tokenAddress The address of the Token
  ...
  */
  ...
  /**
  * @notice Get a Phoenix Securities Token name
 ...
 /**
  * @notice Get a Phoenix Securities token owner EIN
  * @param  _tokenAddress The address of the token
 ...
 /**
  * @notice Get a Phoenix Securities token description
  * @param  _tokenAddress The address of the token
 ...
 /**
  * @notice Get a Phoenix Securities token decimals
  * @param  _tokenAddress The address of the token
