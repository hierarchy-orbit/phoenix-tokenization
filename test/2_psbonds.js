...
contract('Testing PSToken Payment', function (accounts) {
...
console.log(users)
  ...
  describe('Checking PSToken functionality (BONDS)', async() =>{
    ...
    it('PSToken can be created', async () => {
      ...
      newToken = await PSToken.new(
          1, // Token Id
          2, // STO Type (0: Shares, 1: Units, 2: Bonds)
    ...
    it('PSToken set Bond Properties', async () => {
